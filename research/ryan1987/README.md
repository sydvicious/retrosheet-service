...
**This defaults to warehouse, not localhost.** Warehouse is production for this project,
...
warehouse.** Reaching warehouse requires Tailscale to be running on whatever machine you
run this from.
...
When this study was first run, Plex (then production) and the local mart were
verified identical (15,999,097 play rows, matching season lines).
