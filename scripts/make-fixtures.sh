...
mkdir -p "$OUT"
KEEP="GAME_ID,EVENT_TX,EVENT_CD,H_CD,AB_FL,SH_FL,SF_FL,DP_FL,TP_FL,EVENT_OUTS_CT,RBI_CT,WP_FL,PB_FL,PO1_FLD_CD,PO2_FLD_CD,PO3_FLD_CD,ASS1_FLD_CD,ASS2_FLD_CD,ASS3_FLD_CD,ASS4_FLD_CD,ASS5_FLD_CD,ERR1_FLD_CD,ERR2_FLD_CD,ERR3_FLD_CD"
